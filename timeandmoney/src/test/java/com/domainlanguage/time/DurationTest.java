...
public class DurationTest {
	...
	public void testToLocaleString() {
		Duration s20 = Duration.seconds(20);
		Duration m10 = Duration.minutes(10);
		Duration ms40 = Duration.milliseconds(40);
		Duration d60 = Duration.days(60);
		Duration h15 = Duration.hours(15);

		assertEquals("1m 59s", Duration.seconds(119).toLocalizedString(Locale.US));
		assertEquals("1分 59秒", Duration.seconds(119).toLocalizedString(Locale.JAPAN));
		assertEquals("1분 59초", Duration.seconds(119).toLocalizedString(Locale.KOREA));
		assertEquals("60일 15시간", d60.plus(h15).toLocalizedString(Locale.KOREA));
		assertEquals("60일 15시간 20초", d60.plus(h15).plus(s20).toLocalizedString(Locale.KOREA));
	}
