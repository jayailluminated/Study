 ...
 * ========================================================================
 */
package jjseo.test.module.matchers;
...
/**
 * A custom hamcrest matcher that matches to true if a java.lang.String is null
 * or an empty literal.
 *
...
public class IsStrongPassword extends TypeSafeMatcher<String> {
    /**
     * Checks the condition of this matcher against the given parameter. In this
     * case we check if the parameter is not null and is not ''.
     *
     * @param str
     *            parameter to evaluate
     * @return true if the parameter is not null and not an empty string, return
     *         false otherwise
     */
    @Override
    ...
    /**
     * Helper method to check if the password contains a special symbol. Special
     * symbols are considered one of the following: !, ", #, $, %, &, ', (, ),
     * *, +, -, ., /
     *
     * @param str
     *            the password
    ...
    /**
     * Another factory method to create a new instance of the IsEmptyOrNull
     * matcher.
     *
